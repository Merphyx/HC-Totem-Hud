...
public class ModMenuConfig {
    public static Screen create(Screen parent) {
        ...
        general.addEntry(entryBuilder.startIntField(Text.of("Warnschwellenwert"), config.warningThreshold)
                ...
                .setTooltip(Text.of("Hier kannst du einstellen, ab wann die Warnung angezeigt werden soll. \n z.B. 1 ist der Warnschwellenwert dann wird die Warnung angezeigt wenn du von 2 auf 1 runterfällst."))
                .build());
